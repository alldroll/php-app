...
Можно самому попробовать настроить веб сервер (либо использовать php builtin server), mysql, php и т.д.

Честно говоря я проверил работоспособность только на Unix системах, хотя на Windows все тоже должно работать.
